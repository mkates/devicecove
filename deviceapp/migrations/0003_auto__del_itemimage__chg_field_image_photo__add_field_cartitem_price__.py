...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.alter_column(u'deviceapp_image', 'photo', self.gf('imagekit.models.fields.ProcessedImageField')(max_length=100))
        # Adding field 'CartItem.price'
        db.add_column(u'deviceapp_cartitem', 'price',
                      self.gf('django.db.models.fields.BigIntegerField')(default=0),
                      keep_default=False)

        # Deleting field 'BalancedBankAccount.verified_date'
        db.delete_column(u'deviceapp_balancedbankaccount', 'verified_date')

        # Deleting field 'BalancedBankAccount.verification_uri'
        db.delete_column(u'deviceapp_balancedbankaccount', 'verification_uri')

        # Deleting field 'BalancedBankAccount.verified'
        db.delete_column(u'deviceapp_balancedbankaccount', 'verified')
    ...
    def backwards(self, orm):
        ...
        # Changing field 'Image.photo'
        db.alter_column(u'deviceapp_image', 'photo', self.gf('django.db.models.fields.files.ImageField')(max_length=100))
        # Deleting field 'CartItem.price'
        db.delete_column(u'deviceapp_cartitem', 'price')

        # Adding field 'BalancedBankAccount.verified_date'
        db.add_column(u'deviceapp_balancedbankaccount', 'verified_date',
                      self.gf('django.db.models.fields.DateTimeField')(null=True, blank=True),
                      keep_default=False)

        # Adding field 'BalancedBankAccount.verification_uri'
        db.add_column(u'deviceapp_balancedbankaccount', 'verification_uri',
                      self.gf('django.db.models.fields.CharField')(default=0, max_length=255),
                      keep_default=False)

        # Adding field 'BalancedBankAccount.verified'
        db.add_column(u'deviceapp_balancedbankaccount', 'verified',
