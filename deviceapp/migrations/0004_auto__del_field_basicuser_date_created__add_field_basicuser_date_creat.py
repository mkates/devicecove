...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'BasicUser.date_created'
        db.delete_column(u'deviceapp_basicuser', 'date_created')

        # Adding field 'BasicUser.date_created_two'
        db.add_column(u'deviceapp_basicuser', 'date_created_two',
                      self.gf('django.db.models.fields.DateTimeField')(auto_now_add=True, null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Adding field 'BasicUser.date_created'
        db.add_column(u'deviceapp_basicuser', 'date_created',
                      self.gf('django.db.models.fields.DateTimeField')(auto_now_add=True, null=True, blank=True),
                      keep_default=False)

        # Deleting field 'BasicUser.date_created_two'
        db.delete_column(u'deviceapp_basicuser', 'date_created_two')
    ...
    models = {
        ...
        u'deviceapp.basicuser': {
            ...
            'date_created_two': ('django.db.models.fields.DateTimeField', [], {'auto_now_add': 'True', 'null': 'True', 'blank': 'True'}),
