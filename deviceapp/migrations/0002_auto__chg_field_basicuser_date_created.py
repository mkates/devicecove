...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'BasicUser.date_created'
        db.alter_column(u'deviceapp_basicuser', 'date_created', self.gf('django.db.models.fields.DateTimeField')(auto_now_add=True, null=True))

    def backwards(self, orm):

        # Changing field 'BasicUser.date_created'
        db.alter_column(u'deviceapp_basicuser', 'date_created', self.gf('django.db.models.fields.DateTimeField')(auto_now_add=True, default=datetime.datetime(2014, 1, 28, 0, 0)))
