...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'PromoCode.uses_left'
        db.add_column(u'deviceapp_promocode', 'uses_left',
                      self.gf('django.db.models.fields.IntegerField')(default=10000, max_length=5),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'PromoCode.uses_left'
        db.delete_column(u'deviceapp_promocode', 'uses_left')
