...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'BasicUser.creation_date'
        db.add_column(u'deviceapp_basicuser', 'creation_date',
                      self.gf('django.db.models.fields.DateField')(auto_now_add=True, default=datetime.datetime(2014, 2, 27, 0, 0), blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'BasicUser.creation_date'
        db.delete_column(u'deviceapp_basicuser', 'creation_date')
